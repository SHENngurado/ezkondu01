        ...
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-md-4 text-center">
                    <h3 class="h5">Fecha inicio</h3>
                    <div class="w-100">
            <form action="{{ url('/fechainiciosorteo') }}" enctype="multipart/form-data" method="post" class="datepickers" autocomplete="off" data-toogle="validator" role="form">
            {{ csrf_field() }}
              <div class="form-group">
                <!-- <label class="label-control" for="id_start_datetime">Datetime picker</label> -->
                <div class="input-group date" id="id_0">
                  <input type="text" name="fechainicio" value="" class="form-control" placeholder="MM/DD/YYYY hh:mm:ss" required/>
                  <button type="submit" class="btn btn-info button">Siguiente</button>
                </div>
              </div>
            </form>
                    </div>
